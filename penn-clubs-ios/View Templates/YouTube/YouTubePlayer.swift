...
// Copied from https://github.com/gilesvangruisen/Swift-YouTube-Player to avoid
// using cocoa pods. Will fork and create swift package to ensure proprer attribution
