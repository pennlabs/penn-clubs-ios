        ...
        willSet {
            ...
            if let clubAnnotation = newValue as? ClubAnnotation {
                if let imageUrl = clubAnnotation.imageUrl {
                    ...
                    imgView.image = nil
                    titleLabel.attributedText = NSAttributedString(string: "Missing")
                }
            }
        }
    }
...
//        setupLabel()
    ...
    func setupLabel() {
        ...
        pin.addSubview(titleLabel)
        
        titleLabel.centerXAnchor.constraint(equalTo: pin.centerXAnchor).isActive = true
        titleLabel.topAnchor.constraint(equalTo: pin.topAnchor, constant: width/2).isActive = true
    }
    
    func setupImgView() {
        imgView.translatesAutoresizingMaskIntoConstraints = false
        pin.insertSubview(imgView, belowSubview: titleLabel)
